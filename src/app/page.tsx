...
export default function Home() {
  return (
    <div className="font-[family-name:var(--font-geist-sans)] max-w-6xl mx-auto mt-12 sm:mt-24 px-4 sm:px-0">
      <main className="">
      ...
      <footer className="mx-auto w-full text-sm mt-12 mb-6 text-gray-700">
        2024 Tremor Labs, Inc.
      </footer>
    </div>
  );
}
